...
uint256 hashGenesisBlock("0xf4e7c2639b7f1321f864e0ae37bc7cfffadc21754e506db6566a5baab590dfc6");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Charged: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Charged Signed Message:\n";
...
{
    // Charged: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 26250); // Charged: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 600; // Charged: 3.5 days
static const int64 nTargetSpacing = 180; // Charged: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Charged: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Charged: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Charged: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x04f1e10cc277147b826b046ce5f244cc02765331a251a93978c17d83d4920682");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The Start Of Some Good Things !";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 8000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("18cbef5f0c6070bd8ef03a4be8fc0a538e2866bfd4a93311a8032a3f7a9d5a0ca9a7014874e5e5d914dba0403aa23014f1f8752bf47ecaf3485ae77aa9f862c673") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1448215746;
        block.nBits    = 504365644;
        block.nNonce   = 2580493963;

        if (fTestNet)
        {
            block.nTime    = 1448215746;
            block.nNonce   = 330436651;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x26d44fcb89ee03478806cd704c363718d1f9dac502b0287268c396d29a356e00"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Charged: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ChargedMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ChargedMiner : ProcessBlock, block not accepted");
    }
